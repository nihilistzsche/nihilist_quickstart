return function()
    ...
    if nqs.chestnumber > 0 then table.insert(nqs.insertion_info, { name = "wooden-chest", count = nqs.chestnumber }) end

    if nqs.fuelnumber > 0 then table.insert(nqs.insertion_info, { name = nqs.fueltype, count = nqs.fuelnumber }) end
    ...
    if nqs.pyCoal then
        ...
        if nqs.pyIndustry then
            ...
            if nqs.pondsnumber > 0 then table.insert(nqs.insertion_info, { name = "tailings-pond", count = 1 }) end
        end
    ...
    if nqs.gatenumber > 0 then table.insert(nqs.insertion_info, { name = "gate", count = nqs.gatenumber }) end

    if nqs.cliffexplosivenumber > 0 then
        table.insert(nqs.insertion_info, { name = "cliff-explosives", count = nqs.cliffexplosivenumber })
    end
