...
local function quickstart_bne(e)
    ...
    if nqs_bne.initInfo[e.player_index] then return end
    ...
    if player.controller_type == defines.controllers.character then
        ...
        -- Doing the insertion directly in execute here instead of this file like nqs because of the grid insertion for armor.
        execute(player)
